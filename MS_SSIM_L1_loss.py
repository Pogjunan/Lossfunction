...
print("MS_SSIM_L1_LOSS imported successfully!")
print("MS-SSIM (Multi-Scale Structural Similarity) 과 L1 손실을 결합하여 이미지 유사도를 측정")
print("MS-SSIM은 이미지의 구조적 유사성을 여러 스케일에서 측정하여 더욱 정확한 유사도 평가를 제공")
print("L1 손실은 픽셀 단위 차이의 절댓값 합을 계산")

print("두 손실을 결합함으로써, 생성된 이미지가 원본 이미지와 구조적으로 유사하면서도 픽셀 단위의 차이가 적도록 학습을 유도")
